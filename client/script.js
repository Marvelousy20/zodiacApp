console.log('JS successfully running')
...
function getZodiac() {
	...
	for(let i=0; i<zodiacs.length; i++) {
		if(userSearch === zodiacs[i].name.toLowerCase()) {
			...
			document.getElementById('users-search').innerHTML = zodiacs[i].description + '<br>' ;


			document.getElementById('img').src = zodiacs[i].image ;

			document.getElementById('user-name').innerHTML = 'Hey, ' + userName.toUpperCase() ;
		}
	}
}
